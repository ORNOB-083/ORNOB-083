...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=24&duration=3000&pause=500&color=BD93F9&center=true&vCenter=true&width=600&lines=Building+scalable+web+apps;React+%2F+Next.js;Pixel-perfect+with+Tailwind+CSS;Always+learning+new+things" />
</p>
...
I'm a **student developer** who lives at the intersection of design, engineering, and AI.
I care deeply about writing **clean, performant code** and crafting interfaces that feel
...
- <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Activities/Artist%20Palette.png" width="22" />&nbsp;&nbsp; **Designing:** Intuitive UIs with a strong eye for detail and user experience
...
- <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Smilies/Robot.png" width="22" />&nbsp;&nbsp; **Exploring:** Machine Learning and Cyber Security
...
![tools](https://img.shields.io/badge/-%F0%9F%9A%80%20My%20Stack-833ab4)
![sep](https://img.shields.io/badge/-%3A-833ab4)
...
class About extends ORNOB-083 {
  const myStack = {
    "Languages"   : { "HTML5", "CSS3", "JavaScript", "PHP", "C++" },
    "Frameworks"  : { "React", "Next.js" },
    "Styling"     : { "Tailwind CSS", "DaisyUI", "HeroUI", "Framer Motion", "GSAP" },
...
<p align="center">
  ...
  <a href="https://www.youtube.com/@ShalehinAhmed" target="_blank">
